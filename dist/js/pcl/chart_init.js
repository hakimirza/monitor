...
function chart_init(id) {
  ...
  var ctx = document.getElementById('pie_ijin'+id).getContext('2d');
  var donats = new Chart(ctx, {
    type: 'doughnut',
    data: {
      datasets: [{
      // data: [3350, 70, 30],
...
// LINE CHART
// PROGRES HARIAN
var ctx2 = document.getElementById('line_input'+id).getContext('2d');
$('#line_inputHarian').attr('height', 100);
var lines1 = new Chart(ctx2, {
  type: 'line',
  data: {
    datasets: [{
...
var ctx3 = document.getElementById('line_durasi'+id).getContext('2d');
$('#line_durasiCacah').attr('height', 100);
var lines2 = new Chart(ctx3, {
  type: 'line',
  data: {
    datasets: [{
